...
#[test]
fn call_abs() -> Result<(), asm::AsmFailure> {
    assert_eq!(
        compile("call [0x1234]")?,
...
#[test]
fn jmp_abs() -> Result<(), asm::AsmFailure> {
    assert_eq!(
        compile("jmp [0x1234]")?,
...
#[test]
fn st_abs() -> Result<(), asm::AsmFailure> {
    assert_eq!(
...
#[test]
fn st_abs_label() -> Result<(), asm::AsmFailure> {
    assert_eq!(
...
#[test]
fn ld_abs() -> Result<(), asm::AsmFailure> {
    assert_eq!(
...
#[test]
fn ld_abs_label() -> Result<(), asm::AsmFailure> {
    assert_eq!(
...
#[test]
fn ld_offset() -> Result<(), asm::AsmFailure> {
    assert_eq!(
        compile("ld r1, [r2:r3 - 0x04]")?,
        vec![
            0x20, 0x04, 0x12, 0x30, 0x35, 0x08, 0x42, 0x70, 0x27, 0x01, 0x12, 0x27, 0x43, 0x70,
            0x51, 0x23,
        ]
    );
    Ok(())
