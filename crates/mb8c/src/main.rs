use mb8c::gen_ir::gen_ir;
use mb8c::gen_mb8::gen_mb8;
use mb8c::irdump::dump_ir;
use mb8c::parse::parse;
use mb8c::preprocess::Preprocessor;
use mb8c::regalloc::alloc_regs;
use mb8c::sema::sema;
use mb8c::token::tokenize;
